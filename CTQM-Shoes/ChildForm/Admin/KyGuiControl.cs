...
{
    public partial class KyGuiform : UserControl
    {
        public KyGuiform()
        {
            InitializeComponent();
        ...
        private void KyGuiControl_Load(object sender, EventArgs e)
        {
            ...
            MaKhachHangcbx_Load();
            MaNhanViencbx_Load();
            AdminGrV.DataSource = KyGuiBUS.LayDSKyGui();
        }
        ...
        {            
            ...
            MaNhanViencbx.Text = AdminGrV.Rows[i].Cells[2].Value.ToString();
            ...
            Loaicbx.Text = AdminGrV.Rows[i].Cells[8].Value.ToString();
            ...
            DonGiaBantxt.Text = AdminGrV.Rows[i].Cells[12].Value.ToString();
        ...
        private void DoItbtn_Click(object sender, EventArgs e)
        {
            if (boolThem == true)
            {
                ...
                KyGuiBUS.ThemKyGui(kg);
                KyGuiControl_Load(sender, e);
            }
            else if (boolXoa == true)
            {
                KyGuiBUS.XoaKyGui(MaGiaycbx.Text);
                KyGuiControl_Load(sender, e);
            }
            else if (boolSua == true)
            {
